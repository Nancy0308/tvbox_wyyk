...
async function detail(id) {
    ...
    for (const info of detail) {
        ...
        if (i.startsWith('鍦板尯锛 ')) {
            vod.vod_area = i.substring(3);
        } else if (i.startsWith('骞翠唤锛 ')) {
            vod.vod_year = i.substring(3);
        } else if (i.startsWith('绫诲瀷锛 ')) {
            vod.vod_type = i.substring(3);
        } else if (i.startsWith('瀵兼紨锛 ')) {
            vod.vod_director = i.substring(3);
        } else if (i.startsWith('涓绘紨锛 ')) {
            vod.vod_actor = i.substring(3);
        } else if (i.startsWith('璇█锛 ')) {
